                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <x-text-input id="selling_price" name="selling_price" type="number" step="0.01" min="0" class="block mt-1 w-full" :value="old('selling_price')" required />
                                <x-input-error :messages="$errors->get('selling_price')" class="mt-2" />
                            </div>
                            <div>
                                <x-input-label for="tax_percentage" :value="__('IVA (%)')" />
                                <x-text-input id="tax_percentage" name="tax_percentage" type="number" step="0.01" min="0" max="100" class="block mt-1 w-full" :value="old('tax_percentage', '0')" />
                    ...
                    <div class="mt-6">
                        ...
                        <div id="productsContainer" class="space-y-2">
                            <div class="flex items-center space-x-2 product-row">
                                ...
                                <input type="number" step="0.001" name="products[0][quantity]" min="0.001" value="1" required placeholder="Cant." class="w-full sm:w-20 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm text-sm">
