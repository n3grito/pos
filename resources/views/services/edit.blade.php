                    ...
                    <div class="mt-6">
                        ...
                        <div id="productsContainer" class="space-y-2">
                            ...
                            <div class="flex items-center space-x-2 product-row">
                                ...
                                <input type="number" step="0.001" name="products[{{ $i }}][quantity]" min="0.001" required placeholder="Cant." class="w-full sm:w-20 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm text-sm" value="{{ $p->pivot->quantity }}">
