<x-guest-layout>
    <div class="text-center">
        ...
        @if($welcomeContent)
            <div class="mt-6 text-sm text-gray-600 dark:text-gray-400 leading-relaxed text-left">
        ...
        <div class="mt-8 space-y-3">
            ...
            @if (Route::has('register') && \App\Models\GeneralSetting::get('registration_enabled', '1') === '1')
