                    ...
                    <form method="POST" action="{{ route('users.update', $user) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="nit" class="block mt-1 w-full" type="text" name="nit" :value="old('nit', $user->nit)" maxlength="11" placeholder="00000000000" />
                            ...
                            <div>
                                ...
                                <x-text-input id="phone_personal" class="block mt-1 w-full" type="text" name="phone_personal" :value="old('phone_personal', $user->phone_personal)" />
