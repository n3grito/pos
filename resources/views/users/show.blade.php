                ...
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $user->branch->name ?? __('N/A') }}</p>
                        </div>
                            <div>
                                <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Almacén') }}</h4>
                                <p class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $user->warehouse->name ?? __('N/A') }}</p>
                            </div>
                            <div>
                        ...
                        <div>
                            <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Roles') }}</h4>
                            <div class="mt-1 space-y-1">
                                ...
                                @empty
                                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('Sin roles asignados') }}</p>
                                @endforelse
                            </div>
                        </div>
                        <div>
                    ...
                    <div class="mt-6 flex space-x-3">
                        <a href="{{ route('users.edit', $user) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 dark:bg-blue-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-500 dark:hover:bg-blue-600">
                            {{ __('Editar') }}
                        </a>
